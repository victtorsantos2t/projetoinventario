    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button className="gap-2 rounded-lg h-11 px-6 shadow-md bg-primary hover:bg-primary/90 text-white font-bold transition-all hover:scale-[1.02] active:scale-[0.98]">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col overflow-hidden">
                    ...
                    <div className="p-8 overflow-y-auto max-h-[60vh] space-y-8 custom-scrollbar bg-white dark:bg-zinc-900">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2 flex flex-col sm:flex-row gap-6 items-center bg-neutral-app dark:bg-white/5 p-5 rounded-xl border border-transparent transition-all">
                                ...
                                <div className="flex-1 w-full space-y-2">
                                    <Label htmlFor="avatar_url" className="text-[10px] font-bold text-text-muted uppercase tracking-widest ml-1">URL da Foto (Opcional)</Label>
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            className="pl-10 h-11 rounded-lg bg-white dark:bg-zinc-800 border-transparent focus:bg-white dark:focus:bg-zinc-800 transition-all shadow-sm text-sm"
                                        />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-2 md:col-span-2">
                                <Label htmlFor="nome" className="text-[10px] font-bold text-text-muted uppercase tracking-widest ml-1">Nome Completo</Label>
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        value={formData.nome}
                                        onChange={handleChange}
                                        className="pl-10 h-11 rounded-lg bg-neutral-app dark:bg-white/5 border-transparent focus:bg-white dark:focus:bg-zinc-800 transition-all shadow-sm text-sm font-bold"
                                    />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="email" className="text-[10px] font-bold text-text-muted uppercase tracking-widest ml-1">Email Corporativo</Label>
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        onChange={handleChange}
                                        className="pl-10 h-11 rounded-lg bg-neutral-app dark:bg-white/5 border-transparent focus:bg-white dark:focus:bg-zinc-800 transition-all shadow-sm text-sm"
                                    />
                                </div>
                            </div>
                            ...
                            {/* Cargo */}
                            <div className="space-y-2">
                                <Label htmlFor="cargo" className="text-[10px] font-bold text-text-muted uppercase tracking-widest ml-1">Cargo / Função</Label>
                                <div className="relative">
                            ...
                            {/* Setor */}
                            <div className="space-y-2">
                                <Label htmlFor="setor_id" className="text-[10px] font-bold text-text-muted uppercase tracking-widest ml-1">Setor / Departamento</Label>
                                <div className="relative">
                                    <Briefcase className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-text-muted" />
                                    <select
                                        id="setor_id"
                                        ...
                                        onChange={handleChange}
                                        className="w-full h-11 pl-10 pr-4 rounded-lg border border-transparent bg-neutral-app dark:bg-white/5 text-sm font-bold focus:bg-white dark:focus:bg-zinc-800 focus:ring-2 focus:ring-primary-600/20 transition-all outline-none appearance-none shadow-sm dark:text-white"
                                    >
                            ...
                            {/* Senha */}
                            <div className="space-y-2 md:col-span-2">
                                <Label htmlFor="senha" className="text-[10px] font-bold text-text-muted uppercase tracking-widest ml-1">Senha Temporária</Label>
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        onChange={handleChange}
                                        className="pl-10 h-11 rounded-lg bg-neutral-app dark:bg-white/5 border-transparent focus:bg-white dark:focus:bg-zinc-800 transition-all shadow-sm font-mono text-sm"
                                    />
                                </div>
                            </div>

                            <div className="md:col-span-2">
                                <label className="flex items-center gap-3 cursor-pointer group bg-slate-50 dark:bg-white/5 px-4 py-3 rounded-lg border border-slate-100 dark:border-white/5 shadow-sm">
                                    <input
                                        type="checkbox"
                            ...
                            <div className="md:col-span-2 space-y-4">
                                <Label className="text-[10px] font-bold text-text-muted uppercase tracking-widest ml-1 block">Nível de Acesso</Label>
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                    {['Visualizador', 'Técnico', 'Admin'].map((role) => (
                                        ...
                                        >
                                            ...
                                            <span className={cn("font-bold text-xs uppercase tracking-tight", formData.role === role ? 'text-text-primary dark:text-white' : 'text-text-muted')}>{role}</span>
                                            {formData.role === role && (
                                ...
                                <div className="bg-slate-50 dark:bg-white/2 p-4 rounded-xl border border-slate-100 dark:border-white/5 flex items-center justify-center">
